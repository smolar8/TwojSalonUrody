...
import "./styleTextBottomAbout/textBottomAbout.css";
  ...
  return (
    <div className="motto">
      ...
      <article>
        ...
        tworzyć wyjątkowe miejsce, sięgamy po najlepsze rozwiązania i
      ...
      <p>
        ...
        kongresach i sympozjach poświęconych kosmetyce i urodzie. Chętnie
        wprowadzamy nowości oraz doskonalimy zabiegi tradycyjne. Zapraszamy
        Państwa do skorzystania z bezpłatnych, profesjonalnych konsultacji
        kosmetycznych, gdzie pomożemy dobrać odpowiedni program zabiegów oraz
...
export default TextBottomAbout;
